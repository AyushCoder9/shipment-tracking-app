      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
        <div className="flex items-center gap-3">
          <div className="relative inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brand-gradient text-white shadow-glow">
            ...
            <span className="absolute -bottom-0.5 -right-0.5 h-2.5 w-2.5 rounded-full bg-emerald-400 ring-2 ring-white animate-pulse-soft" />
          </div>
          <div>
            <h1 className="text-base font-semibold text-slate-900 sm:text-lg">
              Samex<span className="text-brand-600">.Delivery</span>
            </h1>
            <p className="hidden text-xs text-slate-500 sm:block">B2B logistics command center</p>
          </div>
        </div>
