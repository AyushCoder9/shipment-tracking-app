  ...
  return (
    <div className="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
      ...
      <svg
        ...
        viewBox="0 0 28 10"
        fill="none"
        className="flex-shrink-0 text-brand-500 dark:text-brand-400"
        aria-hidden="true"
      >
        <path
          d="M0 5 Q 14 -2 26 5"
      ...
      <div className="flex items-center gap-1.5">
        <MapPin className="h-3.5 w-3.5 text-brand-600 dark:text-brand-400" strokeWidth={2.4} />
        <span className="truncate font-medium text-slate-900 dark:text-slate-100" title={destination}>
          {destination}
        </span>
      </div>
    </div>
